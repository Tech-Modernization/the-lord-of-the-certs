...
possible_opponents = [Opponent("AWS Solutions Architect Associate", 3000, 1000, saa_questions),
                      Opponent("Azure Fundamentals", 3000, 1000, af_questions),
                      Opponent("Google Cloud Associate", 3000, 1000, gca_questions),
                      Opponent("Certified Kubernetes Administrator", 3000, 1000, cka_questions)]